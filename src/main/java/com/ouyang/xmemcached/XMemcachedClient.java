...
public class XMemcachedClient implements XMemcachedClientMBean, MemcachedClient {
     ...
     */
    public static ThreadLocal<String> NAMESPACE_LOCAL = new ThreadLocal<String>();
    private static Logger log = LoggerFactory
            .getLogger(XMemcachedClient.class);
    private static String CONTINUOUS_TIMEOUT_COUNTER = "ContinuousTimeouts";
    protected AtomicInteger serverOrderCount = new AtomicInteger();
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#getConnectTimeout()
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#setConnectTimeout(long)
     */
    ...
    public void setHealSessionInterval(long healConnectionInterval) {
        ...
        if (null != this.connector) {
            ...
            throw new IllegalStateException("The spi hasn't been started");
        }
    }
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#getConnector()
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#isShutdown()
     */
    ...
    @SuppressWarnings("unchecked")
    private <T> GetsResponse<T> gets0(final String key,
    ...
    private Session sendCommand(final Command cmd)
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#addServer(java.lang.String,
     * int)
     */
     ...
     *
     * @see
     * MemcachedClient#addServer(java.net.InetSocketAddress
     * )
     */
     ...
     *
     * @see
     * MemcachedClient#removeServer(java.lang.String)
     */
    ...
    private void connect(final InetSocketAddressWrapper inetSocketAddressWrapper)
        ...
        if (this.connectionPoolSize > 1) {
            log.warn("You are using connection pool for xmemcached spi,it's not recommended unless you have test it that it can boost performance in your app.");
        }
    ...
    @SuppressWarnings("unchecked")
    private <T> Object fetch0(final String key, final byte[] keyBytes,
     ...
     *
     * @see
     * MemcachedClient#setBufferAllocator(net.rubyeye
    ...
    private void optimiezeSetReadThreadCount(Configuration conf,
                                             int addressCount) {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#get(java.lang.String, long,
     * Transcoder)
     */
    @SuppressWarnings("unchecked")
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#get(java.lang.String,
     * Transcoder)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#gets(java.lang.String, long,
     * Transcoder)
     */
    @SuppressWarnings("unchecked")
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#gets(java.lang.String)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#get(java.util.Collection,
     * long, Transcoder)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#gets(java.util.Collection,
     * long, Transcoder)
     */
    @SuppressWarnings("unchecked")
    ...
    private <T> Map<String, T> getMulti0(final Collection<String> keys,
    ...
    private <T> Command sendGetMultiCommand(
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#set(java.lang.String, int, T,
     * Transcoder, long)
     */
    public <T> boolean set(String key, final int exp, final T value,
    ...
    private <T> byte[] checkStoreArguments(final String key,
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#set(java.lang.String, int,
     * java.lang.Object)
     */
     ...
     * Transcoder)
     */
    public <T> boolean set(final String key, final int exp,
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#add(java.lang.String, int, T,
     * Transcoder, long)
     */
    public <T> boolean add(String key, final int exp, final T value,
                           final Transcoder<T> transcoder, final long timeout)
            throws TimeoutException, InterruptedException, MemcachedException {
        key = this.preProcessKey(key);
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#add(java.lang.String, int,
     * java.lang.Object)
     */
     ...
     */
    @SuppressWarnings("unchecked")
    public boolean add(final String key, final int exp,
                       final Object value, final long timeout) throws TimeoutException,
            InterruptedException, MemcachedException {
     ...
     * Transcoder)
     */
    public <T> boolean add(final String key, final int exp,
                           final T value, final Transcoder<T> transcoder)
            throws TimeoutException, InterruptedException, MemcachedException {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#replace(java.lang.String,
     * int, T, Transcoder, long)
     */
    public <T> boolean replace(String key, final int exp, final T value,
                               final Transcoder<T> transcoder, final long timeout)
            throws TimeoutException, InterruptedException, MemcachedException {
        key = this.preProcessKey(key);
        byte[] keyBytes = this.checkStoreArguments(key, exp, value);
     ...
     */
    public boolean replace(final String key, final int exp,
     ...
     * int, T, Transcoder)
     */
    public <T> boolean replace(final String key, final int exp,
                               final T value, final Transcoder<T> transcoder)
            throws TimeoutException, InterruptedException, MemcachedException {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#append(java.lang.String,
     * java.lang.Object)
     */
     ...
     * java.lang.Object, long)
     */
    public boolean append(String key, final Object value,
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#prepend(java.lang.String,
     * java.lang.Object)
     */
     ...
     * java.lang.Object, long)
     */
    public boolean prepend(String key, final Object value,
                           final long timeout) throws TimeoutException, InterruptedException,
            MemcachedException {
        key = this.preProcessKey(key);
        byte[] keyBytes = this.checkStoreArguments(key, 0, value);
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#cas(java.lang.String, int,
     * java.lang.Object, long)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#cas(java.lang.String, int, T,
     * Transcoder, long, long)
     */
    public <T> boolean cas(String key, final int exp, final T value,
    ...
    private <T> boolean cas0(final String key, final int exp,
     ...
     * Transcoder)
     */
    public <T> boolean cas(String key, final int exp,
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#cas(java.lang.String,
     * GetsResponse, CASOperation)
     */
    public <T> boolean cas(final String key, GetsResponse<T> getsReponse,
     ...
     * CASOperation)
     */
    public <T> boolean cas(final String key,
                           final CASOperation<T> operation) throws TimeoutException,
            InterruptedException, MemcachedException {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#delete(java.lang.String, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#incr(java.lang.String, int)
     */
    public long incr(String key, final long delta)
            throws TimeoutException, InterruptedException, MemcachedException {
        key = this.preProcessKey(key);
    ...
    public void decrWithNoReply(String key, final long delta)
            throws InterruptedException, MemcachedException {
        key = this.preProcessKey(key);
        try {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#decr(java.lang.String, int)
     */
    public long decr(String key, final long delta)
            throws TimeoutException, InterruptedException, MemcachedException {
        key = this.preProcessKey(key);
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#flushAll(long)
     */
     ...
     *
     * @see
     * MemcachedClient#flushAll(java.net.InetSocketAddress
     * )
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#flushAll(java.lang.String)
     */
     ...
     *
     * @see
     * MemcachedClient#stats(java.net.InetSocketAddress)
     */
    ...
    public void setConnectionPoolSize(int poolSize) {
        if (!this.shutdown && this.getAvaliableServers().size() > 0) {
            throw new IllegalStateException(
                    "Xmemcached spi has been started");
        }
        if (poolSize <= 0) {
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#delete(java.lang.String)
     */
     ...
     * (non-Javadoc)
     *
     * @see MemcachedClient#getTranscoder()
     */
    @SuppressWarnings("unchecked")
    ...
    public int getConnectionSizeBySocketAddress(InetSocketAddress address) {
    ...
    public void setEnableHealSession(boolean enableHealSession) {
        if (this.connector != null) {
            ...
            throw new IllegalStateException("The spi has not been started.");
        }
    }
