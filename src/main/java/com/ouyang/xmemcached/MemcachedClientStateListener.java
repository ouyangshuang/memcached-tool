...
/**
 * MemcachedClient state listener.When spi startup,shutdown,connected to a
 * memcached server or disconnected happened,spi will notify the listener
